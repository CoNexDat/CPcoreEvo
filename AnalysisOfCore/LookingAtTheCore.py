...
ASnames_df=pd.read_csv('../complementaryFiles/ASN_ASname.csv',header='infer')       #ASN--> ASnames (CAIDA?)
ASclass_df=pd.read_csv('../complementaryFiles/20150801.as2types.txt',header='infer',sep='|') #ASN--> type (CAIDA: http://data.caida.org/datasets/as-classification/)
